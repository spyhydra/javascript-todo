...
//get all selector here for easy task
...
//this function for adding a tasklist 
...
//function for completed todo mark and unmark
...
// function for date and update greeting 
updateGreeting = function(){
    hour = TODAY.getHours();
    if (hour>=5 & hour<=11){
        greetingElement.innerHTML = "Good Morning, Chetan";
    }else if (hour>=12 & hour<=16){
        greetingElement.innerHTML = "Good Afternoon, Chetan";
    }else{
        greetingElement.innerHTML = "Good Evening, Chetan";
    }
}
